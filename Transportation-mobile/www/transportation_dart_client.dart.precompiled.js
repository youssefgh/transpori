...
function dart_precompiled($collectedClasses) {
  ...
  function Station_closure(this_1) {
    this.this_1 = this_1;
  }
  ...
  function Station_closure0(box_0) {
    this.box_0 = box_0;
  }
  Station_closure0.builtin$cls = "Station_closure0";
  if (!"name" in Station_closure0)
    Station_closure0.name = "Station_closure0";
  $desc = $collectedClasses.Station_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Station_closure0.prototype = $desc;
