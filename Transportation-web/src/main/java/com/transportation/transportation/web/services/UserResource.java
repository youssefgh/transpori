...
import com.transportation.transportation.web.services.security.UserAuthorized;
...
public class UserResource {
    ...
    @EJB//(lookup = "java:global/Transportation-ear/Transportation-ejb-1.0-SNAPSHOT/ServiceUserImplz")
     ...
     * com.transportation.transportation.web.services.UserResource
     *
     * @param email
     * @param password
     * @param requestContext
     * @return an instance of
     * com.transportation.transportation.model.entities.User
     */
    @GET
    @Path("{email}/{password}")
