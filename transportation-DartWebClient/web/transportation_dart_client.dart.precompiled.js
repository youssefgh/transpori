...
function dart_precompiled($collectedClasses) {
  ...
  function BusLine(id, name, _onClick, _onDblClick, _onMousedown, _onMousemove, _onMouseout, _onMouseover, _onMouseup, _onRightclick, $$unsafe) {
    this.id = id;
    this.name = name;
  ...
  BusLine.builtin$cls = "BusLine";
  if (!"name" in BusLine)
    BusLine.name = "BusLine";
  $desc = $collectedClasses.BusLine;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BusLine.prototype = $desc;
  function CustomMap(originPosition, destination, stations, selectedTransportationLine, suggestions, _onBoundsChanged, _onCenterChanged, _onClick, _onDblClick, _onDrag, _onDragend, _onDragstart, _onHeadingChanged, _onIdle, _onMaptypeidChanged, _onMousemove, _onMouseout, _onMouseover, _onProjectionChanged, _onResize, _onRightclick, _onTilesloaded, _onTiltChanged, _onZoomChanged, $$unsafe) {
    this.originPosition = originPosition;
    this.destination = destination;
    this.stations = stations;
    this.selectedTransportationLine = selectedTransportationLine;
  ...
  CustomMap.builtin$cls = "CustomMap";
  if (!"name" in CustomMap)
    CustomMap.name = "CustomMap";
  $desc = $collectedClasses.CustomMap;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CustomMap.prototype = $desc;
  ...
  function Destination(marker, $$unsafe) {
    this.marker = marker;
    this.$$unsafe = $$unsafe;
  }
  Destination.builtin$cls = "Destination";
  if (!"name" in Destination)
    Destination.name = "Destination";
  $desc = $collectedClasses.Destination;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Destination.prototype = $desc;
  function Destination_closure(this_0) {
    this.this_0 = this_0;
  }
  Destination_closure.builtin$cls = "Destination_closure";
  if (!"name" in Destination_closure)
    Destination_closure.name = "Destination_closure";
  $desc = $collectedClasses.Destination_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Destination_closure.prototype = $desc;
  function NativeEvent($$unsafe) {
    this.$$unsafe = $$unsafe;
  }
  NativeEvent.builtin$cls = "NativeEvent";
  if (!"name" in NativeEvent)
    NativeEvent.name = "NativeEvent";
  $desc = $collectedClasses.NativeEvent;
  if ($desc instanceof Array)
    $desc = $desc[1];
  NativeEvent.prototype = $desc;
  ...
  function MVCArray(_translator, _onInsertAt, _onRemoveAt, _onSetAt, $$unsafe) {
  ...
  function Icon($$unsafe) {
    this.$$unsafe = $$unsafe;
  }
  Icon.builtin$cls = "Icon";
  if (!"name" in Icon)
    Icon.name = "Icon";
  $desc = $collectedClasses.Icon;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Icon.prototype = $desc;
  function Marker(_onAnimationChanged, _onClick, _onClickableChanged, _onCursorChanged, _onDblClick, _onDrag, _onDragend, _onDraggableChanged, _onDragstart, _onFlatChanged, _onIconChanged, _onMousedown, _onMouseout, _onMouseover, _onMouseup, _onPositionChanged, _onRightclick, _onShadowChanged, _onShapeChanged, _onTitleChanged, _onVisibleChanged, _onZindexChanged, $$unsafe) {
    this._onAnimationChanged = _onAnimationChanged;
    this._onClick = _onClick;
    this._onClickableChanged = _onClickableChanged;
    this._onCursorChanged = _onCursorChanged;
    this._onDblClick = _onDblClick;
    this._onDrag = _onDrag;
    this._onDragend = _onDragend;
    this._onDraggableChanged = _onDraggableChanged;
    this._onDragstart = _onDragstart;
    this._onFlatChanged = _onFlatChanged;
    this._onIconChanged = _onIconChanged;
    this._onMousedown = _onMousedown;
    this._onMouseout = _onMouseout;
    this._onMouseover = _onMouseover;
    this._onMouseup = _onMouseup;
    ...
    this._onRightclick = _onRightclick;
    this._onShadowChanged = _onShadowChanged;
    this._onShapeChanged = _onShapeChanged;
    this._onTitleChanged = _onTitleChanged;
  ...
  function StreetViewPanorama(_onCloseclick, _onLinksChanged, _onPanoChanged, _onPositionChanged, _onPovChanged, _onResize, _onVisibleChanged, _onZoomChanged, $$unsafe) {
    this._onCloseclick = _onCloseclick;
    this._onLinksChanged = _onLinksChanged;
    this._onPanoChanged = _onPanoChanged;
    this._onPositionChanged = _onPositionChanged;
    this._onPovChanged = _onPovChanged;
    this._onResize = _onResize;
    this._onVisibleChanged = _onVisibleChanged;
    this._onZoomChanged = _onZoomChanged;
    this.$$unsafe = $$unsafe;
  }
  StreetViewPanorama.builtin$cls = "StreetViewPanorama";
  if (!"name" in StreetViewPanorama)
    StreetViewPanorama.name = "StreetViewPanorama";
  $desc = $collectedClasses.StreetViewPanorama;
  if ($desc instanceof Array)
    $desc = $desc[1];
  StreetViewPanorama.prototype = $desc;
  ...
  function TranslatorForSerializable(_fromJs, _toJs) {
    this._fromJs = _fromJs;
    this._toJs = _toJs;
  }
  TranslatorForSerializable.builtin$cls = "TranslatorForSerializable";
  if (!"name" in TranslatorForSerializable)
    TranslatorForSerializable.name = "TranslatorForSerializable";
  $desc = $collectedClasses.TranslatorForSerializable;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TranslatorForSerializable.prototype = $desc;
  function TranslatorForSerializable_closure(fromJs_0, mapOnlyNotNull_1) {
    this.fromJs_0 = fromJs_0;
    this.mapOnlyNotNull_1 = mapOnlyNotNull_1;
  }
  TranslatorForSerializable_closure.builtin$cls = "TranslatorForSerializable_closure";
  if (!"name" in TranslatorForSerializable_closure)
    TranslatorForSerializable_closure.name = "TranslatorForSerializable_closure";
  $desc = $collectedClasses.TranslatorForSerializable_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TranslatorForSerializable_closure.prototype = $desc;
  function TranslatorForSerializable_closure0(E_2) {
    this.E_2 = E_2;
  }
  TranslatorForSerializable_closure0.builtin$cls = "TranslatorForSerializable_closure0";
  if (!"name" in TranslatorForSerializable_closure0)
    TranslatorForSerializable_closure0.name = "TranslatorForSerializable_closure0";
  $desc = $collectedClasses.TranslatorForSerializable_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TranslatorForSerializable_closure0.prototype = $desc;
  function TypedProxy() {
  }
  TypedProxy.builtin$cls = "TypedProxy";
  if (!"name" in TypedProxy)
    TypedProxy.name = "TypedProxy";
  $desc = $collectedClasses.TypedProxy;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TypedProxy.prototype = $desc;
  function MapPoint($$unsafe) {
    this.$$unsafe = $$unsafe;
  }
  MapPoint.builtin$cls = "MapPoint";
  if (!"name" in MapPoint)
    MapPoint.name = "MapPoint";
  $desc = $collectedClasses.MapPoint;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MapPoint.prototype = $desc;
  function OriginPosition(marker, $$unsafe) {
    this.marker = marker;
    this.$$unsafe = $$unsafe;
  }
  OriginPosition.builtin$cls = "OriginPosition";
  if (!"name" in OriginPosition)
    OriginPosition.name = "OriginPosition";
  $desc = $collectedClasses.OriginPosition;
  if ($desc instanceof Array)
    $desc = $desc[1];
  OriginPosition.prototype = $desc;
  function OriginPosition_closure(this_0) {
    this.this_0 = this_0;
  }
  OriginPosition_closure.builtin$cls = "OriginPosition_closure";
  if (!"name" in OriginPosition_closure)
    OriginPosition_closure.name = "OriginPosition_closure";
  $desc = $collectedClasses.OriginPosition_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  OriginPosition_closure.prototype = $desc;
  function Station(id, marker, $$unsafe) {
    this.id = id;
    this.marker = marker;
    this.$$unsafe = $$unsafe;
  }
  Station.builtin$cls = "Station";
  if (!"name" in Station)
    Station.name = "Station";
  $desc = $collectedClasses.Station;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Station.prototype = $desc;
  function Station_closure(this_0) {
    this.this_0 = this_0;
  }
  Station_closure.builtin$cls = "Station_closure";
  if (!"name" in Station_closure)
    Station_closure.name = "Station_closure";
  $desc = $collectedClasses.Station_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Station_closure.prototype = $desc;
  function BusStation(id, marker, $$unsafe) {
    this.id = id;
    this.marker = marker;
    this.$$unsafe = $$unsafe;
  }
  BusStation.builtin$cls = "BusStation";
  if (!"name" in BusStation)
    BusStation.name = "BusStation";
  $desc = $collectedClasses.BusStation;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BusStation.prototype = $desc;
  function TrainStation(id, marker, $$unsafe) {
    this.id = id;
    this.marker = marker;
    this.$$unsafe = $$unsafe;
  }
  TrainStation.builtin$cls = "TrainStation";
  if (!"name" in TrainStation)
    TrainStation.name = "TrainStation";
  $desc = $collectedClasses.TrainStation;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TrainStation.prototype = $desc;
  function TramwayStation(id, marker, $$unsafe) {
    this.id = id;
    this.marker = marker;
    this.$$unsafe = $$unsafe;
  }
  TramwayStation.builtin$cls = "TramwayStation";
  if (!"name" in TramwayStation)
    TramwayStation.name = "TramwayStation";
  $desc = $collectedClasses.TramwayStation;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TramwayStation.prototype = $desc;
  function TrainLine(id, name, _onClick, _onDblClick, _onMousedown, _onMousemove, _onMouseout, _onMouseover, _onMouseup, _onRightclick, $$unsafe) {
    this.id = id;
    this.name = name;
    this._onClick = _onClick;
    this._onDblClick = _onDblClick;
  ...
  TrainLine.builtin$cls = "TrainLine";
  if (!"name" in TrainLine)
    TrainLine.name = "TrainLine";
  $desc = $collectedClasses.TrainLine;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TrainLine.prototype = $desc;
  function TramwayLine(id, name, _onClick, _onDblClick, _onMousedown, _onMousemove, _onMouseout, _onMouseover, _onMouseup, _onRightclick, $$unsafe) {
    this.id = id;
    this.name = name;
    this._onClick = _onClick;
    this._onDblClick = _onDblClick;
  ...
  TramwayLine.builtin$cls = "TramwayLine";
  if (!"name" in TramwayLine)
    TramwayLine.name = "TramwayLine";
  $desc = $collectedClasses.TramwayLine;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TramwayLine.prototype = $desc;
  ...
  function main__closure0(httpRequest_0) {
    this.httpRequest_0 = httpRequest_0;
  }
  ...
  function setLineMode_closure() {
  }
  setLineMode_closure.builtin$cls = "setLineMode_closure";
  if (!"name" in setLineMode_closure)
    setLineMode_closure.name = "setLineMode_closure";
  $desc = $collectedClasses.setLineMode_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  setLineMode_closure.prototype = $desc;
  function setStationMode_closure() {
  }
  setStationMode_closure.builtin$cls = "setStationMode_closure";
  if (!"name" in setStationMode_closure)
    setStationMode_closure.name = "setStationMode_closure";
  $desc = $collectedClasses.setStationMode_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  setStationMode_closure.prototype = $desc;
  function setPathMode_closure() {
  }
  setPathMode_closure.builtin$cls = "setPathMode_closure";
  if (!"name" in setPathMode_closure)
    setPathMode_closure.name = "setPathMode_closure";
  $desc = $collectedClasses.setPathMode_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  setPathMode_closure.prototype = $desc;
  function refreshTransportationLines_closure() {
  }
  refreshTransportationLines_closure.builtin$cls = "refreshTransportationLines_closure";
  if (!"name" in refreshTransportationLines_closure)
    refreshTransportationLines_closure.name = "refreshTransportationLines_closure";
  $desc = $collectedClasses.refreshTransportationLines_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  refreshTransportationLines_closure.prototype = $desc;
  function refreshStations_closure() {
  }
  refreshStations_closure.builtin$cls = "refreshStations_closure";
  if (!"name" in refreshStations_closure)
    refreshStations_closure.name = "refreshStations_closure";
  $desc = $collectedClasses.refreshStations_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  refreshStations_closure.prototype = $desc;
  function TransportationLine(id, name, _onClick, _onDblClick, _onMousedown, _onMousemove, _onMouseout, _onMouseover, _onMouseup, _onRightclick, $$unsafe) {
    this.id = id;
    this.name = name;
    this._onClick = _onClick;
    this._onDblClick = _onDblClick;
  ...
  TransportationLine.builtin$cls = "TransportationLine";
  if (!"name" in TransportationLine)
    TransportationLine.name = "TransportationLine";
  $desc = $collectedClasses.TransportationLine;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TransportationLine.prototype = $desc;
  function TransportationLine_init_closure(this_0) {
    this.this_0 = this_0;
  }
  TransportationLine_init_closure.builtin$cls = "TransportationLine_init_closure";
  if (!"name" in TransportationLine_init_closure)
    TransportationLine_init_closure.name = "TransportationLine_init_closure";
  $desc = $collectedClasses.TransportationLine_init_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TransportationLine_init_closure.prototype = $desc;
  function TransportationPath(transportationLines) {
    this.transportationLines = transportationLines;
  }
  TransportationPath.builtin$cls = "TransportationPath";
  if (!"name" in TransportationPath)
    TransportationPath.name = "TransportationPath";
  $desc = $collectedClasses.TransportationPath;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TransportationPath.prototype = $desc;
  TransportationPath.prototype.get$transportationLines = function() {
    return this.transportationLines;
  };
  function TransportationRequest(originPosition, destination) {
    this.originPosition = originPosition;
    this.destination = destination;
  }
  TransportationRequest.builtin$cls = "TransportationRequest";
  if (!"name" in TransportationRequest)
    TransportationRequest.name = "TransportationRequest";
  $desc = $collectedClasses.TransportationRequest;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TransportationRequest.prototype = $desc;
  ...
  IsEnum.prototype.get$value = function(receiver) {
    return this.value;
  };
