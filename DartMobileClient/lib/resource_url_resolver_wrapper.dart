...
class ResourceUrlResolverWrapper implements ResourceUrlResolver {
  ...
  ResourceUrlResolverWrapper(this._uriMapper, this._config)
      : _baseUri = _getBaseUri();

  ResourceUrlResolverWrapper.forTests(
      this._uriMapper, this._config, this._baseUri);
  ...
  static String _getBaseUri() {
    if (Uri.base.authority.isEmpty) {
      ...
      return "${Uri.base.scheme}://" + "/android_asset/www/";
    } else {
